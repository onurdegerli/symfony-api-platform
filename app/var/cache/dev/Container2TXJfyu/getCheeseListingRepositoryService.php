...
// Returns the private 'App\Repository\CheeseListingRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CheeseListingRepository.php';

return $this->privates['App\\Repository\\CheeseListingRepository'] = new \App\Repository\CheeseListingRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
